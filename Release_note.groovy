...
def git_clone() {
   ...
   //checkout scm: [$class: 'GitSCM', userRemoteConfigs: [[url: 'git@github.com:elarahq/'+GIT_REPO+'.git', credentialsId: 'b5b5b230-4f8a-4213-a6ba-7efccc0ae00c' ]], branches: [[name: TAG]]], poll: false
     checkout scm: [$class: 'GitSCM', userRemoteConfigs: [[url: 'git@github.com:GauravMayank/Test_Repo.git', credentialsId: 'test_key-git-ssh' ]], branches: '$BRANCH_NAME'], poll: false  
}
def release_job() {
